...
//Added on 2024.03.08 -begin
// 订单查询过滤条件
// CFutureQryOrderField.FilterFlag
#define DERIVATIVE_ORD_FILTER_L				'L'		//存活订单(未撤销等待成交的订单); orders only wait for being filled
#define DERIVATIVE_ORD_FILTER_A				'A'		//当日所有订单; today all orders


//Added on 2024.03.08 -end


// Contract Category
// CFutureReqOrderInsertField.ContractCategory
#define DERIVATIVE_CONTRACT_CATEGORY_DEFAULT	'0'		//非跨期合约(非必填）
#define DERIVATIVE_CONTRACT_CATEGORY_SPREAD		'1'		//跨期合约(必填）
